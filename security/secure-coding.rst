...
uncontrolled access can be devastating, including taking down significant
portion of the DNS infrastructure with a `DDOS attack`_.
...
.. _DDOS attack: http://www.theverge.com/2016/10/21/13362354/dyn-dns-ddos-attack-cause-outage-status-explained
